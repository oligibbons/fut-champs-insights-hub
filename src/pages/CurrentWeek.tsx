...
const CurrentWeek = () => {
  ...
  return (
    <>
      ...
      <GameCompletionPopup game={completedGame} isOpen={!!completedGame} onClose={() => setCompletedGame(null)} />
      <WeekCompletionPopup week={completedWeek} isOpen={!!completedWeek} onClose={closeWeekModal} />
    </>
  );
};
