        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="flex items-center gap-3 text-white text-xl">
              <div className="p-3 bg-fifa-blue/20 rounded-2xl border border-fifa-blue/30 floating-element">
      ...
      <Card className="glass-card rounded-3xl shadow-depth-lg border-0 animate-fade-in">
        ...
        <CardContent className="space-y-8">
          ...
          {gamesPlayed > 0 && totalXG > 0 && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 slide-in-right">
          ...
          {weekData.isCompleted && (
            <Button onClick={handleNewWeek} className="w-full modern-button-primary text-lg py-5 rounded-2xl">
              <Trophy className="h-5 w-5 mr-2" />
              View Week Summary
            </Button>
          )}
