    ...
    return (
        <form onSubmit={handleSubmit(processSubmit)} className="flex flex-col h-full">
            <Tabs defaultValue="details" className="flex flex-col flex-1 min-h-0">
                ...
                <TabsContent value="details" className="overflow-y-auto mt-4 pr-4 pb-4 space-y-6">
                ...
                <TabsContent value="opponent" className="overflow-y-auto mt-4 pr-4 pb-4 space-y-6">
                ...
                <TabsContent value="players" className="flex-1 overflow-y-auto mt-4 pr-4 pb-4">
